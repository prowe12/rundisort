...
c
c    Note: I had to change the declaration of PMOM_CLD from
c    PMOM_CLD(0:MAXMOM,*), to PMOM_CLD(0:NMOM,*),
c    because MAXMOM needs to be > NMOM in case we need to increase
c    NMOM to be at least as large as NSTR. PMR, 2016/08/29


      INTEGER  MAXCLY, MAXMOM, MAXPHI, MAXULV, MAXUMU, CLDLYR(*), NCLDLYR
     &         I, J, ICLDLYR
      PARAMETER ( MAXMOM = 1000 )
...
cf2py intent(in)  :: MAXCLY,MAXULV, MAXUMU, MAXPHI
