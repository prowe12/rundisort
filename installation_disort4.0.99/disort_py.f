c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c   Modifications made by P. Rowe, 2021/04/02:
c   (approximate line numbers given)
c
c       Commented out the following lines which display header (~562)
c          IF( .NOT.PASS1 .AND. LEN( HEADER ).NE.0 )
c        &    WRITE( *,'(//,1X,100(''*''),/,A,/,1X,100(''*''))' )
c        &    ' DISORT: '//HEADER
c
c    Also *might add* msg, errflag to outputs in DISORT call 
c    These are indicated with PMR and are on the following lines:
c    lines 373-377, 454-457, 511-519, 546-551, 2500-2502, 2545-2550, 
c          2695-2705, 4176-4178, 4213-4218, 4233-4234, 4282-4288, 
c          4922-4932, 5199-5205
...
c
c     Some types were not declared (PMR, 2021/04/02):
c     Added NTAU, NCUT as INTEGER
c     Added UMU0 type as REAL  
c +-------------------------------------------------------------------+
...
c   Added UMU0 as real PMR, 2021/04/02
c ---------------------------------------------------------------------
...
c
c   Added integer NAZZ  PMR 2021/04/02
c+---------------------------------------------------------------------+
